...
resource "aws_iam_policy" "aws_load_balancer_controller" {
  ...
  description = "Permissões para o AWS Load Balancer Controller em laboratório."

  # Política simplificada para laboratório.
  # Em produção, substitua pela política oficial mais restritiva do controller.
  policy = jsonencode({
    Version = "2012-10-17"
    Statement = [
      {
